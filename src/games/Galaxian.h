...
#define GALAXIAN {"galaxian", "Galaxian", {295, 32 * 8, 32 * 8, {0 * 8, 32 * 8 - 0, 2 * 8, 30 * 8 - 0}, ORIENTATION_ROTATE_90, GalaxianRefreshScreen, galaxianGfxDecodeInfo}, 3072000 / 60, {galaxian_rom, NOTHING, galaxian_readmem, galaxian_writemem, galaxian_input_ports, NOTHING, NOTHING, GalaxianInit}, MACHINE_Z80}
