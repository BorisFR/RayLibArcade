...
{
	{ 1, 0x0000, &pengoTileLayout,	   0, 32 },  /* first bank */
    { 1, 0x1000, &pengoSpriteLayout,    0, 32 },
    { 1, 0x2000, &pengoTileLayout,   4*32, 32 },  /* second bank */
    { 1, 0x3000, &pengoSpriteLayout, 4*32, 32 },
    { -1 }
};
...
#define PENGO {"pengo", "Pengo", {295, 36*8, 28*8, { 0*8, 36*8-1, 0*8, 28*8-1 }, ORIENTATION_ROTATE_90, PengoRefreshScreen, pengoGfxDecodeInfo}, 3072000 / 60, {pengo_rom, PengoDecodeRoms, pengo_readmem, pengo_writemem, pengo_input_ports, NOTHING, NOTHING, PengoInit}, MACHINE_Z80}
