...
#define INVADERS {"invaders", "Space Invaders", {512, 224, 256, VISIBLE_AREA_FULL, ORIENTATION_DEFAULT, NOTHING, NOTHING}, 3000000 / 60, {invaders_rom, NOTHING, invaders_readmem, invaders_writemem, invaders_input_ports, invaders_readport, invaders_writeport}, MACHINE_8080BW}

ROM_START(invaders_rom)
ROM_REGION(0x10000)                                // 64k for code
ROM_LOAD("9316b-0869_m739h.h1", 0x0000, 0x0800, 0x734f5ad8)
ROM_LOAD("9316b-0856_m739g.g1", 0x0800, 0x0800, 0x6bfaca4a)
ROM_LOAD("9316b-0855_m739f.f1", 0x1000, 0x0800, 0x0ccead96)
ROM_LOAD("9316b-0854_m739e.e1", 0x1800, 0x0800, 0x14e538b0)
ROM_END
