...
#define INVADERS {"invaders", "Space Invaders", {224, 256, VISIBLE_AREA_FULL, ORIENTATION_DEFAULT, NOTHING, NOTHING}, 3000000 / 60, {invaders_rom, NOTHING, invaders_readmem, invaders_writemem, invaders_input_ports, invaders_readport, invaders_writeport}, MACHINE_8080BW}
