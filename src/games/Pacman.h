...
static struct GfxDecodeInfo pacmanGfxDecodeInfo[] = {
    {ROM_GFX, 0x0000, &pacmanTileLayout, 0, 128},
    {ROM_GFX, 0x1000, &pacmanSpriteLayout, 0, 128},
    {-1}};
...
#define PACMAN {"pacman", "Pacman", {316, 256, 288, {16, 256 - 16, 0, 288}, ORIENTATION_ROTATE_90, PacmanRefreshScreen, pacmanGfxDecodeInfo}, 3072000 / 60, {pacman_rom, NOTHING, pacman_readmem, pacman_writemem, pacman_input_ports, NOTHING, pacman_writeport}, MACHINE_Z80}
...
static struct MemoryWriteAddress pacman_writemem[] = {
    ...
    {0x4000, 0x43ff, MWA_RAM}, // pacman_videoram_w}, //, &videoram, &videoram_size },
    {0x4400, 0x47ff, MWA_RAM}, // pacman_colorram_w}, //, &colorram },
    ...
    {0xc000, 0xc3ff, MWA_RAM}, // pacman_videoram_w}, // mirror address for video ram,
    {0xc400, 0xc7ef, MWA_RAM}, // pacman_colorram_w}, // used to display HIGH SCORE and CREDITS
