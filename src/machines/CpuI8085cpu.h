...
#define M_IN    I.XX.D=RDOPARG(); I.AF.B.h=readPortHandler(I.XX.D); I.AF.B.l=(I.AF.B.l&CF)|ZSP[I.AF.B.h]
#define M_OUT   I.XX.D=RDOPARG(); writePortHandler(I.XX.D,I.AF.B.h)
